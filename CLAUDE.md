...
2. **不要猜测需求**：如果 spec 中没有明确定义某个行为，问我，不要自行
补充。

3. **out-of-scope 是红线**：proposal.md 中标注为 out-of-scope 的功能，
严禁实现。
...
- Change 用 domain-based naming（如 user-auth、ai-chat），不用
  feature-level naming（如 add-sidebar、fix-layout）
